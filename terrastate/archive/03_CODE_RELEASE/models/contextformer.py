"""Contextformer architecture used by the TerraState history operator.

Adapted from earthnet-models-pytorch v0.1.0. See LICENSES.md.
"""
...
class PVT_embed(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, pretrained=True, frozen=False):
        ...
        model_id = "pvt_v2_" + chr(98) + "0.in1k"
