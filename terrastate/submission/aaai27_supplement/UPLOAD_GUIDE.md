...
- **D — Q3 Protocol:** frozen extreme heat--drought selection, 84 matched
  pairs, exact-season standardized-RMS donor matching, 45 unique donors, 31
  geographic clusters, weather controls, cluster bootstrap, and the
  non-causal evidence boundary.
...
- `supplementary.pdf`: 233,677 bytes.
